...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // pg_gsb_frais_validerfraishorsforfait
        if ($pathinfo === '/validerfraishorsforfait') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\SaisirFraisController::validerfraishorsforfaitAction',  '_route' => 'pg_gsb_frais_validerfraishorsforfait',);
        }
        ...
        if (0 === strpos($pathinfo, '/su')) {
            ...
            // pg_gsb_frais_suivrefrais
            if ($pathinfo === '/suivrefrais') {
                return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\SuivreFraisController::indexAction',  '_route' => 'pg_gsb_frais_suivrefrais',);
            }

        }

        // pg_gsb_frais_validerfrais
        if ($pathinfo === '/validerfrais') {
            return array (  '_controller' => 'PgGsbFraisBundle:ValiderFrais:index',  '_route' => 'pg_gsb_frais_validerfrais',);
        }
